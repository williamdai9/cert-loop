...
export const basePlan = [
  { id: "w1", title: "建立坐标系", subtitle: "诊断 + 解剖与生理", chapters: "第 1–2 章", domain: "运动科学", tasks: ["完成 30 题诊断测试", "梳理肌节、运动单位与肌纤维类型", "掌握三平面、力矩、功率和杠杆", "掌握心血管循环与呼吸气体交换"] },
  ...
  { id: "w9", title: "代谢与周期化", subtitle: "有氧处方、赛季与负荷管理", chapters: "第 21–22 章", domain: "计划设计", tasks: ["设计完整有氧处方与赛季进阶", "比较线性与非线性周期化", "绘制赛季年度计划", "完成计划设计专题卷"] },
