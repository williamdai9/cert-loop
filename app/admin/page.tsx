...
function Overview({ data }: { data: AdminPayload }) {
  ...
  return <>
    ...
    <section className={styles.metrics}>{[
      [totals.chapters,"chapters"],[totals.sections,"deep dives"],[totals.knowledgePoints,"knowledge points"],[totals.questions,"questions"],[totals.textbookFigures,"textbook figures"],[totals.noteFigures,"note figures"],[totals.mindMaps,"mind maps"],[data.cloud.research.length,"research items"],
